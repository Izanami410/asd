        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Categoria</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
						                ...
						                <ul class="collapse">
											...
											<li class="active-link"><a href="../categoria/nuevo.php">Nuevo</a></li>
						                </ul>
						            </li>
                                    <li>
						                <a href="#">
...
$sql = "select * from categoria where nomcat='$nomcat' or descripcion='$descripcion'";
...
$sql2="INSERT INTO categoria(nomcat,descripcion)VALUES ('$nomcat','$descripcion')";
...
messages: {
         nomcat: "Digitar nombre valido",
         descripcion: "Digitar descripcion valida"
