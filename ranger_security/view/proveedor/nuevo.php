        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li><a href="mostrar.php">Proveedor</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                 <label class="control-label">Telefono</label>
                                                    <input type="text" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="telef"  class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" maxlength="14" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="ruc" class="form-control">
                                                        </div>
                                                    </div>
                                    </div>
										...
										<div class="row">
													...
													<div class="col-sm-6">
														<div class="form-group">
															...
															<input type="text" name="direcci"  class="form-control">
														</div>
													</div>
                                                    ...
                                                    <div class="col-sm-6" style="display:none;">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="estado" value="1" class="form-control">
                                                        </div>
                                                    </div>
...
$sql = "select * from proveedor where ruc='$ruc' or correo='$correo' or telef='$telef'";
...
$sql2="INSERT INTO proveedor(ruc,nombre,correo,telef,direcci,ciudad,estado)VALUES ('$ruc','$nombre','$correo','$telef','$direcci','$ciudad','$estado')";
...
messages: {
         ...
         ruc: "Digitar ruc valido",
         correo: "Digitar correo valido",
         telef: "Digitar telefono valido",
         direcci: "Digitar direccion valida",
         ciudad: "Digitar ciudad valida"
     },
